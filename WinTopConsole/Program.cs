...
namespace WinTopConsole
{
    class Program
    {
        ...
        static void List(IEnumerable<Window> allwins, string start)
        {
                    ...
                    case "notopmost":
                        {
                            ...
                            var wins = allwins.Where(x => x.Text.Equals(title, StringComparison.CurrentCultureIgnoreCase));
                            ...
                            foreach (var win in wins)
                            {
                                ...
                                if (tm)
                                {
                                    Console.Write($"Nailing {title} to topmost ... ");
                                }
                                else
                                {
                                    Console.Write($"Take {title} off from topmost ... ");
                                }
